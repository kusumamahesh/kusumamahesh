...
# consumer=KafkaConsumer(os.getenv("bootstrap_servers"),
#                                  auto_offset_reset='earliest',
#                                  value_deserializer=lambda m: json.loads(m.decode('utf-8')))
    
consumer.subscribe(['device_data-SCMXPERT_raw'])
# consumer.subscribe([os.getenv("device_data")])

#client = MongoClient('localhost:27017')
client = MongoClient("mongodb+srv://m001-student:m001-mongodb-basics@cluster0.aejnp.mongodb.net/SCM?retryWrites=true&w=majority")
